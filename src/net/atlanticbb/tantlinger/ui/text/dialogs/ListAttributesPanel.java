...
public final class ListAttributesPanel extends HTMLAttributeEditorPanel {
    ...
    public ListAttributesPanel(HashMap ht) {
        super();
        initialize();
        setAttributes(ht);
    ...
    private JComboBox getTypeCombo() {
        if (typeCombo == null) {
            ...
            typeCombo.addItemListener((java.awt.event.ItemEvent e) -> {
                updateForType();
            });
        }
        return typeCombo;
    ...
    private JCheckBox getStyleCB() {
        if (styleCB == null) {
            ...
            styleCB.addItemListener((java.awt.event.ItemEvent e) -> {
    ...
    private JCheckBox getStartAtCB() {
        if (startAtCB == null) {
            ...
            startAtCB.addItemListener((java.awt.event.ItemEvent e) -> {
                startAtField.setEnabled(startAtCB.isSelected());
            });
        }
        return startAtCB;
